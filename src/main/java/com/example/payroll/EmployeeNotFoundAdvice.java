...
public class EmployeeNotFoundAdvice {
    ...
    String employeeNotFoundHandler(EmployeeNotFoundException ex) { //The body of the advice generates the content. In this case, it gives the message of the exception.
